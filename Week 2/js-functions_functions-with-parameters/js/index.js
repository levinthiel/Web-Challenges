...
const greetAlice = "Welcome Alice, good to see you again!\n"; //  \n   is a line break like <br>
const greetBob = "Welcome Bob, good to see you again!\n";
const greetMary = "Welcome Mary, good to see you again!";
const greeteveryone = greetAlice + greetBob + greetMary;
function greet() {
...
Note: Separation text means the text that is logged into the console before each exercise. For example: "-------------" and "Exercise 1:" are the separation texts 
