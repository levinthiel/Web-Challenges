...
copyInUppercaseButton.addEventListener("click", () =>{
  const input1 = firstCopyInUppercaseInput.value
  secondCopyInUppercaseInput.value = input1.toUpperCase();
})
// --^-- write your code here --^--
...
switchValueButton.addEventListener("click", ()=>{
  const input1 = firstSwitchValueInput.value;
  const input2 = secondSwitchValueInput.value;
